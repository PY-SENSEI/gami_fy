    ...
    <div className="relative w-full h-screen overflow-hidden mb-[10%]">
      ...
      <div className="relative z-10 pt-6 text-center">
        <h1
          ...
          className="text-5xl font-bold tracking-widest md:-mb-14"
        >
          FIGHTERS
        </h1>
      </div>
      ...
      {/* main content area */}
      <div
        className="relative  z-10 flex md:flex-row flex-col items-center w-full h-full 
      p-4"
      >
        <div className="w-full md:w-2/4 flex flex-col md:ml-10">
          {/* Selected avatar info card */}
          <div
            className="bg-gray-900/80 background-blur-sm rounded-lg p-4 mb-4 border-border-gray-800
          ...
          >
            ...
            <div className="flex gap-3">
              <button
                className="px-4 py-1 bg-violet-900 text-white rounded-md font-semibold
          ...
          <div className="grid grid-cols-2 gap-4">
            {/* viki card */}
            <div
              className="relative bg-gray-900/70 backdrop-blur-sm
               rounded-lg p-3 border flex lg:flex-row flex-col justify-between px-12
            ...
            >
              ...
              {/* Hightlight for selected avatar */}
              {selectedAvatar === "VIKI" && (
            ...
            >
              ...
              {/* Avatar visual placeholder */}
              <div className="w-20 h-20 bg-gray-800/50 rounded-md flex items-center justify-center mb-2">
                <img src="public\images\EVA.png" alt="EVAI-IMG" />
              </div>
              {/* Star rating */}
              <div className="flex">
                {[...Array(4)].map((_, i) => (
        ...
        <div
          className="relative md:w-2/4 w-full md:h-full h-80 flex items-center justify-center 
        overflow-hidden "
        >
